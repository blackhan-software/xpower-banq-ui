...
async function redeem(
    ctx: TxExitContext, data: TxExitData,
) {
...
async function redeem_error(
    p: Position, e: CallExceptionError, ctx: Pick<TxExitContext, "vault">
) {
...
const call_error = async (
    p: Position, e: CallExceptionError, { vault: v }: Pick<TxExitContext, "vault">
) => {
