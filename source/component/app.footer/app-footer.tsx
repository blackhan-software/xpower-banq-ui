...
import { usePoolContract, usePositionContract, useTellerMode, useTellerToken, useVaultContract, useWalletChainId } from "@/react/hook";
...
export function AppFooter() {
    return <>
        ...
        <Span class="ms-auto">
            <TermsLink />
            <Span>&nbsp;|&nbsp;</Span>
            <Link href="https://www.avalabs.org/">
