...
export function useAmountPositions(): Positions {
    const { portfolio_amount: amount } = appStore();
    const { set_portfolio_amount: set_amount } = appStore();
...
export function useSupplyPositions(): Positions {
    const { portfolio_supply: supply } = appStore();
    const { set_portfolio_supply: set_supply } = appStore();
...
export function useBorrowPositions(): Positions {
    const { portfolio_borrow: borrow } = appStore();
    const { set_portfolio_borrow: set_borrow } = appStore();
